...
[![npm](https://img.shields.io/npm/v/@diotoborg/minus-ducimus.svg)](https://www.npmjs.com/package/@diotoborg/minus-ducimus)
[![downloads](https://img.shields.io/npm/dt/@diotoborg/minus-ducimus.svg)](https://www.npmjs.com/package/@diotoborg/minus-ducimus)
[![types](https://img.shields.io/npm/types/@diotoborg/minus-ducimus.svg)](https://www.npmjs.com/package/@diotoborg/minus-ducimus)
[![licence](https://img.shields.io/github/license/mnasyrov/@diotoborg/minus-ducimus.svg)](https://github.com/diotoborg/minus-ducimus/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@diotoborg/minus-ducimus/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@diotoborg/minus-ducimus?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@diotoborg/minus-ducimus**][@diotoborg/minus-ducimus/docs]             | Core elements, state and effect management | [Docs][@diotoborg/minus-ducimus/docs], [API][@diotoborg/minus-ducimus/api]             |
| [**@diotoborg/minus-ducimus-react**][@diotoborg/minus-ducimus-react/docs] | Tooling for React.js                       | [Docs][@diotoborg/minus-ducimus-react/docs], [API][@diotoborg/minus-ducimus-react/api] |
...
```
npm install @diotoborg/minus-ducimus @diotoborg/minus-ducimus-react --save
```
...
import { useConst, useObservable, useQuery } from '@diotoborg/minus-ducimus-react';
...
[@diotoborg/minus-ducimus/docs]: packages/@diotoborg/minus-ducimus/README.md
[@diotoborg/minus-ducimus/api]: packages/@diotoborg/minus-ducimus/docs/README.md
[@diotoborg/minus-ducimus-react/docs]: packages/@diotoborg/minus-ducimus-react/README.md
[@diotoborg/minus-ducimus-react/api]: packages/@diotoborg/minus-ducimus-react/docs/README.md
